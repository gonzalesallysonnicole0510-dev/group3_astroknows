...
class _QuizGame_NeptuneState extends State<QuizGame_Neptune> {
  ...
  List<Map<String, dynamic>> quiz = [
    {'question': 'Neptune Question 1', 'answers': ['x', 'yes', 'x'], 'correct': 1},
    {'question': 'Neptune Question 2', 'answers': ['x', 'x', 'yes'], 'correct': 2},
    {'question': 'Neptune Question 3', 'answers': ['yes', 'x', 'x'], 'correct': 0},
    {'question': 'Neptune Question 4', 'answers': ['x', 'yes', 'x'], 'correct': 1},
    {'question': 'Neptune Question 5', 'answers': ['x', 'x', 'yes'], 'correct': 2},
    {'question': 'Neptune Question 6', 'answers': ['yes', 'x', 'x'], 'correct': 0},
    {'question': 'Neptune Question 7', 'answers': ['x', 'yes', 'x'], 'correct': 1},
    {'question': 'Neptune Question 8', 'answers': ['x', 'x', 'yes'], 'correct': 2},
    {'question': 'Neptune Question 9', 'answers': ['yes', 'x', 'x'], 'correct': 0},
    {'question': 'Neptune Question 10', 'answers': ['x', 'yes', 'x'], 'correct': 1},
  ];
        ...
        setState(() {
          if (currentQuestion < quiz.length - 1) {
            ...
            Navigator.pushReplacement(  // go to achievement page when all questions are answered
              context,
              MaterialPageRoute(
                builder: (context) => AchievementPage(star: 500, planet: 'neptune'),
              ),
            );
          }
          });
