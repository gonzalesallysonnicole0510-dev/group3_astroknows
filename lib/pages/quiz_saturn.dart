...
class _QuizGame_SaturnState extends State<QuizGame_Saturn> {
  ...
  List<Map<String, dynamic>> quiz = [
    {
      'question': 'Saturn Question 1',
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Saturn Question 2',
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Saturn Question 3',
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Saturn Question 4',
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Saturn Question 5',
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Saturn Question 6',
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Saturn Question 7',
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Saturn Question 8',
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Saturn Question 9',
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Saturn Question 10',
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
  ];
