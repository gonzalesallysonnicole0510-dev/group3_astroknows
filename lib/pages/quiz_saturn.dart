...
class _QuizGame_SaturnState extends State<QuizGame_Saturn> {
  ...
  List<Map<String, dynamic>> quiz = [
    {
      'question': 'Saturn Question 1',  // question 1
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Saturn Question 2',  // question 2
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Saturn Question 3',  // question 3
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Saturn Question 4', // question 4
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Saturn Question 5',  // question 5
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Saturn Question 6',  // question 6
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Saturn Question 7',  // question 7
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Saturn Question 8',  // question 8
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Saturn Question 9',  // question 9
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Saturn Question 10',  // question 10
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    }
  ];
