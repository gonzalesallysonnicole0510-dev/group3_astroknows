...
class QuizGame_Uranus extends StatefulWidget {
  const QuizGame_Uranus({super.key});

  @override
  State<QuizGame_Uranus> createState() => _QuizGame_UranusState();
}

enum AsteroidDirection { up, down }
enum PlayerDirection { up, down }

class _QuizGame_UranusState extends State<QuizGame_Uranus> {
