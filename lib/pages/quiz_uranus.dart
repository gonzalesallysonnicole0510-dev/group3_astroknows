...
class _QuizGame_UranusState extends State<QuizGame_Uranus> {
  ...
  List<Map<String, dynamic>> quiz = [
    {
      'question': 'Uranus Question 1',  // question 1
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Uranus Question 2',  // question 2
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Uranus Question 3',  // question 3
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Uranus Question 4', // question 4
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Uranus Question 5',  // question 5
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Uranus Question 6',  // question 6
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'UranusEarth Question 7',  // question 7
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    },
    {
      'question': 'Uranus Question 8',  // question 8
      'answers': ['x', 'x', 'yes'],
      'correct': 2
    },
    {
      'question': 'Uranus Question 9',  // question 9
      'answers': ['yes', 'x', 'x'],
      'correct': 0
    },
    {
      'question': 'Uranus Question 10',  // question 10
      'answers': ['x', 'yes', 'x'],
      'correct': 1
    }
  ];
