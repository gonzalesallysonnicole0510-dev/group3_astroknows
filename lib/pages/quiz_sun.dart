...
class _QuizGame_SunState extends State<QuizGame_Sun> {
    ...
    return Row(
      children: List.generate(
        ...
        (index) => Icon(Icons.favorite,
            color: Colors.pink[100], size: screenWidth * 0.04),
      ),
    );
  }
  ...
  List<Map<String, dynamic>> quiz = [
    {'question': 'Sun Question 1', 'answers': ['x', 'yes', 'x'], 'correct': 1},
    {'question': 'Sun Question 2', 'answers': ['x', 'x', 'yes'], 'correct': 2},
    {'question': 'Sun Question 3', 'answers': ['yes', 'x', 'x'], 'correct': 0},
    {'question': 'Sun Question 4', 'answers': ['x', 'yes', 'x'], 'correct': 1},
    {'question': 'Sun Question 5', 'answers': ['x', 'x', 'yes'], 'correct': 2},
    {'question': 'Sun Question 6', 'answers': ['yes', 'x', 'x'], 'correct': 0},
    {'question': 'Sun Question 7', 'answers': ['x', 'yes', 'x'], 'correct': 1},
    {'question': 'Sun Question 8', 'answers': ['x', 'x', 'yes'], 'correct': 2},
    {'question': 'Sun Question 9', 'answers': ['yes', 'x', 'x'], 'correct': 0},
    {'question': 'Sun Question 10', 'answers': ['x', 'yes', 'x'], 'correct': 1},
  ];
        ...
        setState(() {
          if (currentQuestion < quiz.length - 1) {
            ...
            Navigator.pushReplacement(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    const AchievementPage(star: 500, planet: 'sun'),
              ),
            );
          }
        });
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              margin: EdgeInsets.only(
                  right: screenWidth * 0.05, top: screenHeight * 0.01),
      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: Container(
              margin: EdgeInsets.only(
                  bottom: screenHeight * 0.20, right: screenWidth * 0.12),
...
class AsteroidChoice extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      margin: const EdgeInsets.only(top: 20, bottom: 150, left: 190, right: 190),
          ...
          child: TweenAnimationBuilder(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: Colors.cyanAccent.withValues(alpha: 0.8), width: 2),
                boxShadow: [
                  BoxShadow(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _menuButton(context, 'EXIT TO MAIN MENU',
                      isExit: true, onTap: () {
